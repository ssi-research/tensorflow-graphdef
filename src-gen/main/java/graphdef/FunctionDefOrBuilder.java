...
public interface FunctionDefOrBuilder extends
    // @@protoc_insertion_point(interface_extends:uni_model_proto.FunctionDef)
   ...
   * <code>.uni_model_proto.OpDef signature = 1;</code>
   */
  graphdef.OpDefOrBuilder getSignatureOrBuilder();
...
graphdef.AttrValue defaultValue);
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.Integer, graphdef.FunctionDef.ArgAttrs>
  getArgAttr();
  /**
   * <code>map&lt;uint32, .uni_model_proto.FunctionDef.ArgAttrs&gt; arg_attr = 7;</code>
   */
...
graphdef.FunctionDef.ArgAttrs defaultValue);
   ...
   * <code>map&lt;uint32, .uni_model_proto.FunctionDef.ArgAttrs&gt; arg_attr = 7;</code>
   */
  graphdef.FunctionDef.ArgAttrs getArgAttrOrThrow(
      int key);
   ...
   * <code>repeated .uni_model_proto.NodeDef node_def = 3;</code>
   */
  graphdef.NodeDef getNodeDef(int index);
  /**
   * <pre>
   * By convention, "op" in node_def is resolved by consulting with a
   * user-defined library first. If not resolved, "func" is assumed to
   ...
   * <code>repeated .uni_model_proto.NodeDef node_def = 3;</code>
   */
  graphdef.NodeDefOrBuilder getNodeDefOrBuilder(
      int index);
