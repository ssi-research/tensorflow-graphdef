...
public interface OpDefOrBuilder extends
    // @@protoc_insertion_point(interface_extends:uni_model_proto.OpDef)
   ...
   */
  java.util.List<graphdef.OpDef.ArgDef> 
      getInputArgList();
  /**
   * <pre>
   * Description of the input(s).
   ...
   * <code>repeated .uni_model_proto.OpDef.ArgDef input_arg = 2;</code>
   */
  graphdef.OpDef.ArgDef getInputArg(int index);
  /**
   * <pre>
   * Description of the input(s).
   * </pre>
   ...
   * <code>repeated .uni_model_proto.OpDef.ArgDef input_arg = 2;</code>
   */
  java.util.List<? extends graphdef.OpDef.ArgDefOrBuilder> 
   ...
   * <code>repeated .uni_model_proto.OpDef.ArgDef input_arg = 2;</code>
   */
  graphdef.OpDef.ArgDefOrBuilder getInputArgOrBuilder(
      int index);
   ...
   * <code>repeated .uni_model_proto.OpDef.ArgDef output_arg = 3;</code>
   */
  graphdef.OpDef.ArgDef getOutputArg(int index);
  /**
   * <pre>
   * Description of the output(s).
   * </pre>
   ...
   * <code>repeated .uni_model_proto.OpDef.ArgDef output_arg = 3;</code>
   */
  graphdef.OpDef.ArgDefOrBuilder getOutputArgOrBuilder(
      int index);
   ...
   */
  java.util.List<graphdef.OpDef.AttrDef> 
      getAttrList();
  /**
   * <code>repeated .uni_model_proto.OpDef.AttrDef attr = 4;</code>
   */
  graphdef.OpDef.AttrDef getAttr(int index);
  /**
   * <code>repeated .uni_model_proto.OpDef.AttrDef attr = 4;</code>
   */
  int getAttrCount();
   ...
   * <code>repeated .uni_model_proto.OpDef.AttrDef attr = 4;</code>
   */
  java.util.List<? extends graphdef.OpDef.AttrDefOrBuilder> 
      getAttrOrBuilderList();
  /**
   * <code>repeated .uni_model_proto.OpDef.AttrDef attr = 4;</code>
   */
  graphdef.OpDef.AttrDefOrBuilder getAttrOrBuilder(
      int index);
   ...
   */
  graphdef.OpDeprecation getDeprecation();
  /**
   * <pre>
   * Optional deprecation based on GraphDef versions.
   * </pre>
   ...
   * <code>.uni_model_proto.OpDeprecation deprecation = 8;</code>
   */
  graphdef.OpDeprecationOrBuilder getDeprecationOrBuilder();
