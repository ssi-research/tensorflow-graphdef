...
public interface ResourceHandleProtoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:uni_model_proto.ResourceHandleProto)
   ...
   * <code>repeated .uni_model_proto.ResourceHandleProto.DtypeAndShape dtypes_and_shapes = 6;</code>
   */
  graphdef.ResourceHandleProto.DtypeAndShape getDtypesAndShapes(int index);
  /**
   * <pre>
   * Data types and shapes for the underlying resource.
   * </pre>
   ...
   * <code>repeated .uni_model_proto.ResourceHandleProto.DtypeAndShape dtypes_and_shapes = 6;</code>
   */
  graphdef.ResourceHandleProto.DtypeAndShapeOrBuilder getDtypesAndShapesOrBuilder(
      int index);
}
