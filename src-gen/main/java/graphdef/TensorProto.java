 ...
 * </pre>
 *
 * Protobuf type {@code uni_model_proto.TensorProto}
 */
public final class TensorProto extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:uni_model_proto.TensorProto)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return graphdef.TensorProtos.internal_static_uni_model_proto_TensorProto_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return graphdef.TensorProtos.internal_static_uni_model_proto_TensorProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            graphdef.TensorProto.class, graphdef.TensorProto.Builder.class);
  }
  ...
  private graphdef.TensorShapeProto tensorShape_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public graphdef.TensorShapeProto getTensorShape() {
    return tensorShape_ == null ? graphdef.TensorShapeProto.getDefaultInstance() : tensorShape_;
  }
  /**
   * <pre>
   * Shape of the tensor.  TODO(touts): sort out the 0-rank issues.
   ...
   */
  @java.lang.Override
  public graphdef.TensorShapeProtoOrBuilder getTensorShapeOrBuilder() {
    return tensorShape_ == null ? graphdef.TensorShapeProto.getDefaultInstance() : tensorShape_;
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<graphdef.ResourceHandleProto> resourceHandleVal_;
  /**
   * <pre>
   * DT_RESOURCE
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<graphdef.ResourceHandleProto> getResourceHandleValList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends graphdef.ResourceHandleProtoOrBuilder> 
   ...
   */
  @java.lang.Override
  public graphdef.ResourceHandleProto getResourceHandleVal(int index) {
   ...
   */
  @java.lang.Override
  public graphdef.ResourceHandleProtoOrBuilder getResourceHandleValOrBuilder(
      int index) {
    return resourceHandleVal_.get(index);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<graphdef.VariantTensorDataProto> variantVal_;
  /**
   * <pre>
   * DT_VARIANT
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<graphdef.VariantTensorDataProto> getVariantValList() {
    return variantVal_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends graphdef.VariantTensorDataProtoOrBuilder> 
   ...
   */
  @java.lang.Override
  public graphdef.VariantTensorDataProto getVariantVal(int index) {
   ...
   */
  @java.lang.Override
  public graphdef.VariantTensorDataProtoOrBuilder getVariantValOrBuilder(
      int index) {
    return variantVal_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof graphdef.TensorProto)) {
      return super.equals(obj);
    }
    graphdef.TensorProto other = (graphdef.TensorProto) obj;
  ...
  public static graphdef.TensorProto parseFrom(
  ...
  public static graphdef.TensorProto parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static graphdef.TensorProto parseFrom(
  ...
  public static graphdef.TensorProto parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static graphdef.TensorProto parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static graphdef.TensorProto parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(graphdef.TensorProto prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:uni_model_proto.TensorProto)
      graphdef.TensorProtoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return graphdef.TensorProtos.internal_static_uni_model_proto_TensorProto_descriptor;
    }
    ...
    // Construct using graphdef.TensorProto.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public graphdef.TensorProto getDefaultInstanceForType() {
      return graphdef.TensorProto.getDefaultInstance();
    }

    @java.lang.Override
    public graphdef.TensorProto build() {
      graphdef.TensorProto result = buildPartial();
    ...
    @java.lang.Override
    public graphdef.TensorProto buildPartial() {
      graphdef.TensorProto result = new graphdef.TensorProto(this);
    ...
    private void buildPartialRepeatedFields(graphdef.TensorProto result) {
      if (resourceHandleValBuilder_ == null) {
    ...
    private void buildPartial0(graphdef.TensorProto result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof graphdef.TensorProto) {
        return mergeFrom((graphdef.TensorProto)other);
      } else {
    ...
    public Builder mergeFrom(graphdef.TensorProto other) {
      if (other == graphdef.TensorProto.getDefaultInstance()) return this;
      if (other.dtype_ != 0) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 114: {
              graphdef.ResourceHandleProto m =
                  input.readMessage(
                      graphdef.ResourceHandleProto.parser(),
                      extensionRegistry);
              if (resourceHandleValBuilder_ == null) {
                ensureResourceHandleValIsMutable();
            ...
            case 122: {
              graphdef.VariantTensorDataProto m =
                  input.readMessage(
                      graphdef.VariantTensorDataProto.parser(),
                      extensionRegistry);
              if (variantValBuilder_ == null) {
                ensureVariantValIsMutable();
                variantVal_.add(m);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        graphdef.TensorShapeProto, graphdef.TensorShapeProto.Builder, graphdef.TensorShapeProtoOrBuilder> tensorShapeBuilder_;
    /**
     * <pre>
     * Shape of the tensor.  TODO(touts): sort out the 0-rank issues.
     * </pre>
     ...
     * <code>.uni_model_proto.TensorShapeProto tensor_shape = 2;</code>
     */
    public Builder setTensorShape(graphdef.TensorShapeProto value) {
      if (tensorShapeBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.uni_model_proto.TensorShapeProto tensor_shape = 2;</code>
     */
    public Builder mergeTensorShape(graphdef.TensorShapeProto value) {
      if (tensorShapeBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          tensorShape_ != null &&
          tensorShape_ != graphdef.TensorShapeProto.getDefaultInstance()) {
     ...
     * <code>.uni_model_proto.TensorShapeProto tensor_shape = 2;</code>
     */
    public graphdef.TensorShapeProto.Builder getTensorShapeBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
    ...
    public graphdef.TensorShapeProtoOrBuilder getTensorShapeOrBuilder() {
      if (tensorShapeBuilder_ != null) {
        ...
        return tensorShape_ == null ?
            graphdef.TensorShapeProto.getDefaultInstance() : tensorShape_;
      }
    }
    /**
     * <pre>
    ...
    private void ensureResourceHandleValIsMutable() {
      if (!((bitField0_ & 0x00002000) != 0)) {
        resourceHandleVal_ = new java.util.ArrayList<graphdef.ResourceHandleProto>(resourceHandleVal_);
        bitField0_ |= 0x00002000;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        graphdef.ResourceHandleProto, graphdef.ResourceHandleProto.Builder, graphdef.ResourceHandleProtoOrBuilder> resourceHandleValBuilder_;
    ...
    public Builder setResourceHandleVal(
        int index, graphdef.ResourceHandleProto value) {
      if (resourceHandleValBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setResourceHandleVal(
        int index, graphdef.ResourceHandleProto.Builder builderForValue) {
      if (resourceHandleValBuilder_ == null) {
        ensureResourceHandleValIsMutable();
     ...
     * <code>repeated .uni_model_proto.ResourceHandleProto resource_handle_val = 14;</code>
     */
    public Builder addResourceHandleVal(graphdef.ResourceHandleProto value) {
      if (resourceHandleValBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addResourceHandleVal(
        graphdef.ResourceHandleProto.Builder builderForValue) {
      if (resourceHandleValBuilder_ == null) {
        ensureResourceHandleValIsMutable();
    ...
    public Builder addAllResourceHandleVal(
        java.lang.Iterable<? extends graphdef.ResourceHandleProto> values) {
      if (resourceHandleValBuilder_ == null) {
        ensureResourceHandleValIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
     ...
     * <code>repeated .uni_model_proto.ResourceHandleProto resource_handle_val = 14;</code>
     */
    public graphdef.ResourceHandleProto.Builder getResourceHandleValBuilder(
        int index) {
     ...
     * <code>repeated .uni_model_proto.ResourceHandleProto resource_handle_val = 14;</code>
     */
    public graphdef.ResourceHandleProto.Builder addResourceHandleValBuilder() {
      return getResourceHandleValFieldBuilder().addBuilder(
          graphdef.ResourceHandleProto.getDefaultInstance());
    }
    /**
     * <pre>
     * DT_RESOURCE
    ...
    public graphdef.ResourceHandleProto.Builder addResourceHandleValBuilder(
        int index) {
      return getResourceHandleValFieldBuilder().addBuilder(
          index, graphdef.ResourceHandleProto.getDefaultInstance());
    }
    /**
     * <pre>
     * DT_RESOURCE
     ...
     * <code>repeated .uni_model_proto.ResourceHandleProto resource_handle_val = 14;</code>
     */
    public java.util.List<graphdef.ResourceHandleProto.Builder> 
         getResourceHandleValBuilderList() {
      return getResourceHandleValFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        graphdef.ResourceHandleProto, graphdef.ResourceHandleProto.Builder, graphdef.ResourceHandleProtoOrBuilder> 
        getResourceHandleValFieldBuilder() {
      if (resourceHandleValBuilder_ == null) {
    ...
    private void ensureVariantValIsMutable() {
      if (!((bitField0_ & 0x00004000) != 0)) {
        variantVal_ = new java.util.ArrayList<graphdef.VariantTensorDataProto>(variantVal_);
        bitField0_ |= 0x00004000;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        graphdef.VariantTensorDataProto, graphdef.VariantTensorDataProto.Builder, graphdef.VariantTensorDataProtoOrBuilder> variantValBuilder_;
    ...
    public Builder setVariantVal(
        int index, graphdef.VariantTensorDataProto value) {
      if (variantValBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setVariantVal(
        int index, graphdef.VariantTensorDataProto.Builder builderForValue) {
      if (variantValBuilder_ == null) {
        ensureVariantValIsMutable();
     ...
     * <code>repeated .uni_model_proto.VariantTensorDataProto variant_val = 15;</code>
     */
    public Builder addVariantVal(graphdef.VariantTensorDataProto value) {
      if (variantValBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addVariantVal(
        graphdef.VariantTensorDataProto.Builder builderForValue) {
      if (variantValBuilder_ == null) {
        ensureVariantValIsMutable();
    ...
    public Builder addAllVariantVal(
        java.lang.Iterable<? extends graphdef.VariantTensorDataProto> values) {
      if (variantValBuilder_ == null) {
        ensureVariantValIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, variantVal_);
     ...
     * <code>repeated .uni_model_proto.VariantTensorDataProto variant_val = 15;</code>
     */
    public graphdef.VariantTensorDataProto.Builder getVariantValBuilder(
        int index) {
     ...
     * <code>repeated .uni_model_proto.VariantTensorDataProto variant_val = 15;</code>
     */
    public graphdef.VariantTensorDataProto.Builder addVariantValBuilder() {
      return getVariantValFieldBuilder().addBuilder(
          graphdef.VariantTensorDataProto.getDefaultInstance());
    }
    /**
     * <pre>
     * DT_VARIANT
    ...
    public graphdef.VariantTensorDataProto.Builder addVariantValBuilder(
        int index) {
      return getVariantValFieldBuilder().addBuilder(
          index, graphdef.VariantTensorDataProto.getDefaultInstance());
    }
    /**
     * <pre>
     * DT_VARIANT
     ...
     * <code>repeated .uni_model_proto.VariantTensorDataProto variant_val = 15;</code>
     */
    public java.util.List<graphdef.VariantTensorDataProto.Builder> 
         getVariantValBuilderList() {
      return getVariantValFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        graphdef.VariantTensorDataProto, graphdef.VariantTensorDataProto.Builder, graphdef.VariantTensorDataProtoOrBuilder> 
        getVariantValFieldBuilder() {
      if (variantValBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:uni_model_proto.TensorProto)
  }

  // @@protoc_insertion_point(class_scope:uni_model_proto.TensorProto)
  private static final graphdef.TensorProto DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new graphdef.TensorProto();
  }

  public static graphdef.TensorProto getDefaultInstance() {
